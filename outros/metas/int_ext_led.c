...
#define LED PB2       //LED está no pino PB5 
...
DDRB  = 0b00000100;  //somente pino do LED como saída 
PORTB = 0b11111111; //desliga LED e habilita pull-ups  
UCSR0B = 0x00;  
/*necessário desabilitar RX e TX para trabalho com os pinos 
do PORTD no Arduino*/  
...
sei();  
//habilita interrupções globais, ativando o bit I do SREG 
while(1){} 
}
//----------------------------------------------------------------------------------- 
